...
- **WebSocket Integration** for real-time API communication
...
This extension now supports real-time WebSocket communication to replace interval-based API calls:

- **Real-time Updates**: Instant synchronization of URL lists and individual URL changes
- **Automatic Fallback**: Falls back to HTTP API if WebSocket connection fails
- **Connection Management**: Automatic reconnection with exponential backoff
- **Message Queuing**: Queues messages when connection is unavailable

For detailed WebSocket implementation documentation, see [WEBSOCKET_IMPLEMENTATION.md](./WEBSOCKET_IMPLEMENTATION.md).

### WebSocket Endpoints

- URL List: `{WEBSOCKET_BASE_URL}/ws/urls/list/{user_id}/`
- URL Update: `{WEBSOCKET_BASE_URL}/ws/urls/update/{url_id}/`

*WebSocket base URL is automatically derived from your API_BASE_URL configuration*
